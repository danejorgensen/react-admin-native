...
export const crudDelete = (
    ...
    previousData: Record,
    basePath: string,
    redirectTo: any = 'list', /// RedirectionSideEffect = 'list',
    refresh: any = true /// RefreshSideEffect = true
): CrudDeleteAction => ({
    type: CRUD_DELETE,
...
export interface CrudDeleteAction {
    ...
    readonly meta: {
        ...
        onSuccess: {
            ...
            redirectTo: any; /// RedirectionSideEffect;
            refresh: any; /// RefreshSideEffect;
            basePath: string;
        };
        onFailure: {
            notification: NotificationSideEffect;
